...
namespace SportTrack_v1.AccesoDatos.Migrations
{
    ...
    [Migration("20260417000351_ReestructuracionMangas")]
    partial class ReestructuracionMangas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.Manga", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Mangas", "regatas");
                });

            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.MangaResultado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("MangaId", "Carril")
                        .HasDatabaseName("IX_MangaResultados_Carril");

                    b.ToTable("MangaResultados", "regatas");
                });
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.Penalizacion", b =>
                {
                    ...
                    b.Property<int>("MangaResultadoId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("MangaResultadoId")
                        .HasDatabaseName("IX_Penalizaciones_MangaResultadoId");
                    ...
                    b.HasIndex("MangaResultadoId", "TipoPenalizacion")
                        .HasDatabaseName("IX_Penalizaciones_MangaResultadoTipo");
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.Manga", b =>
                {
                    b.HasOne("SportTrack_v1.Entidades.Entidades.EventoPrueba", "EventoPrueba")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_Mangas_EventoPruebas");
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.MangaResultado", b =>
                {
                    b.HasOne("SportTrack_v1.Entidades.Entidades.Inscripcion", "Inscripcion")
                        .WithMany("MangaResultados")
                        .HasForeignKey("InscripcionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_MangaResultados_Inscripciones");

                    b.HasOne("SportTrack_v1.Entidades.Entidades.Manga", "Manga")
                        .WithMany("Resultados")
                        .HasForeignKey("MangaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_MangaResultados_Mangas");
            ...
            modelBuilder.Entity("SportTrack_v1.Entidades.Entidades.Penalizacion", b =>
                {
                    b.HasOne("SportTrack_v1.Entidades.Entidades.MangaResultado", "MangaResultado")
                        .WithMany("Penalizaciones")
                        .HasForeignKey("MangaResultadoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_Penalizaciones_MangaResultados");

                    b.Navigation("MangaResultado");
                });
