    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<Entidades.Entidades.Inscripcion, InscripcionDto>()
                ...
                .ForMember(dest => dest.BoteIdentificador, opt => opt.MapFrom(src => src.BoteIdentificador))
                .ForMember(dest => dest.Carril, opt => opt.MapFrom(src => src.Carril));
            ...
            // Mapeos de Resultado
            CreateMap<Entidades.Entidades.Resultado, ResultadoDto>()
                .ForMember(dest => dest.Estado, opt => opt.MapFrom(src => src.Estado.ToString()))
                .ForMember(dest => dest.ParticipanteNombre, opt => opt.MapFrom(src => $"{src.Inscripcion.Participante.Nombre} {src.Inscripcion.Participante.Apellido}"))
                .ForMember(dest => dest.ClubNombre, opt => opt.MapFrom(src => src.Inscripcion.Participante.Club != null ? src.Inscripcion.Participante.Club.Nombre : string.Empty))
                .ForMember(dest => dest.ClubSigla, opt => opt.MapFrom(src => src.Inscripcion.Participante.Club != null ? src.Inscripcion.Participante.Club.Sigla : string.Empty))
                .ForMember(dest => dest.Carril, opt => opt.MapFrom(src => src.Inscripcion.Carril));
            CreateMap<ResultadoCreateDto, Entidades.Entidades.Resultado>();
